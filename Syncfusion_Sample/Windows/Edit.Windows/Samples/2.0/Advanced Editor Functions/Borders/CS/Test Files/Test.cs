	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void menuItem23_Click(object sender, System.EventArgs e)
		{
			...
			if(DialogResult.OK == dialog.ShowDialog())
			{
                ...
                if ((startline < this.editControl1.PhysicalLineCount) && (endline < this.editControl1.PhysicalLineCount) && endline > startline)
                {
                    if ((endcolumn < this.editControl1.GetLine(endline).LineLength) && (startcolumn < this.editControl1.GetLine(startline).LineLength))
                    {
                        ...
                        CoordinatePoint startCoordinatePoint = this.editControl1.ConvertVirtualPointToCoordinatePoint(startcolumn, startline);
                        CoordinatePoint endCoordinatePoint = this.editControl1.ConvertVirtualPointToCoordinatePoint(endcolumn, endline);
