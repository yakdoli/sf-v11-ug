...
Public Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ' mainMenu1
        ' 
        Me.mainMenu1.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.menuItem1, Me.menuItem12})
        ' 
        ' menuItem1
        ' 
        Me.menuItem1.Index = 0
        Me.menuItem1.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.menuItem2, Me.menuItem3, Me.menuItem4, Me.menuItem5, Me.menuItem6, Me.menuItem7, Me.menuItem14, Me.menuItem8})
        ...
        Me.menuItem12.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.menuItem17, Me.menuItem18, Me.menuItem19, Me.menuItem9, Me.menuItem10, Me.menuItem11, Me.menuItem13})
        Me.menuItem12.Text = "ExportMenu"
        ' 
        ' menuItem17
        ' 
        Me.menuItem17.Index = 0
        Me.menuItem17.Text = "Save as RTF"
        ' 
        ' menuItem18
        ' 
        Me.menuItem18.Index = 1
        Me.menuItem18.Text = "Save as HTML"
        ' 
        ' menuItem19
        ' 
        Me.menuItem19.Index = 2
        Me.menuItem19.Text = "Save as XML"
        ' 
        ' menuItem9
        ' 
        ...
        Me.menuItem10.Text = "Get RTF Source"
        ' 
        ' menuItem11
        ' 
        Me.menuItem11.Index = 5
        Me.menuItem11.Text = "Get HTML Source"
        ' 
        ' menuItem13
        ' 
        Me.menuItem13.Index = 6
        Me.menuItem13.Text = "Get XML Source"
        ' 
        ' menuItem14
        ' 
...
Application.EnableVisualStyles()
    ...
    Private Sub MainMenuClick(sender As Object, e As System.EventArgs) Handles menuItem2.Click, menuItem3.Click, menuItem5.Click, menuItem6.Click, menuItem8.Click, menuItem14.Click
    ...
    Private Sub ExportMenuClick(sender As Object, e As System.EventArgs) Handles menuItem17.Click, menuItem18.Click, menuItem19.Click, menuItem10.Click, menuItem11.Click, menuItem13.Click
        Dim mi As MenuItem = sender 
        Dim sourcecodeDialog As Form2 = Nothing
        ...
        Select Case mi.Text
            ...
            Case "Get RTF Source"
                ...
                sourcecodeDialog.SetText(Me.editControl1.GetTextAsRTF())
                sourcecodeDialog.Text = "RTF Source Code"
                sourcecodeDialog.MoveToBeginning()
                sourcecodeDialog.ShowDialog()
            Case "Get XML Source"
                sourcecodeDialog = New Form2()
                sourcecodeDialog.SetText(Me.editControl1.GetTextAsXML())
