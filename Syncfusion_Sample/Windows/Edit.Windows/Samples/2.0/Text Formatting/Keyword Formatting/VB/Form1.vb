...
#Region "Windows Form Designer generated code"
    ...
    Private Sub InitializeComponent()
        ...
        'mainMenu1
        '
        Me.mainMenu1.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.menuItem1, Me.menuItem8})
        '
        'menuItem1
        '
...
Application.EnableVisualStyles()
    ...
    Private Sub editControl1_ConfigurationChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles editControl1.ConfigurationChanged
        ...
        For Each lang In editControl1.Languages
            ...
            End If
        Next lang
    End Sub 'editControl1_ConfigurationChanged


    Private Sub format_OnCustomDraw(ByVal sender As Object, ByVal e As CustomSnippetDrawEventArgs)
        Dim str As String = e.Text
        str = str.ToLower()
        str = str.Substring(0, 1).ToString().ToUpper() + str.Substring(1, str.Length - 1)
        e.Text = str
    End Sub 'format_OnCustomDraw
    ...
    Private Sub menuItem8_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles menuItem8.Click
        ...
        Me.editControl1.ApplyConfiguration("SQL")
