...
namespace ContentDividersDemo
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private string ConfigPath = Path.GetDirectoryName(Application.ExecutablePath) + @"..\..\..\VBConfig.xml";
		private string BasePath = Path.GetDirectoryName(Application.ExecutablePath) + @"..\..\..\Test Files\Test.vb";
