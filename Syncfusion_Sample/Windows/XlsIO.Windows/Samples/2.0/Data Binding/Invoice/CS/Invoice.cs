...
namespace EssentialXlsIOSamples
{
    ...
    public class Invoice : System.Windows.Forms.Form
    {
        ...
        {
            SqlCeDataAdapter dataAdapter = new SqlCeDataAdapter("Select OrderID from Orders Order By OrderID", connString);
        ...
        {
            SqlCeDataAdapter dataAdapter = new SqlCeDataAdapter("Select ProductID,Quantity,UnitPrice,Discount from SyncOrderDetails where OrderID=" + id, connString);
        ...
        {
            SqlCeDataAdapter dataAdapter = new SqlCeDataAdapter("Select ShipName,ShipAddress,Freight,ShippedDate,ShipCity,ShipCountry from Orders where OrderID=" + id, connString);
            DataSet dataSet = new DataSet();
            dataAdapter.Fill(dataSet);
        ...
        {
            DataTable dataTable = new DataTable();
            SqlCeDataAdapter dataAdapter = new SqlCeDataAdapter("Select Salesperson,ShipName,ShipCountry,CustomerID,OrderDate,RequiredDate from SyncOrders where OrderID=" + id, connString);
            DataSet dataSet = new DataSet();
            dataAdapter.Fill(dataSet);
            dataTable = dataSet.Tables[0];
        ...
        private void InitializeComponent()
        {
            ...
            // listBoxCustomer
            // 
            this.listBoxCustomer.Location = new System.Drawing.Point(335, 53);
            ...
            this.pictureBox1.Size = new System.Drawing.Size(373, 96);
            ...
            this.pictureBox2.Size = new System.Drawing.Size(272, 96);
