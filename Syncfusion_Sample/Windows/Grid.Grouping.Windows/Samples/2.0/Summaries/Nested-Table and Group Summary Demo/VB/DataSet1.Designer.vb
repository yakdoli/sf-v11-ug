...
Namespace SummaryTutorial
	...
	Partial Public Class DataSet1
		...
		Private relationOrdersOrder_x0020_Details As System.Data.DataRelation
		...
		Private Sub InitClass()
			...
			fkc = New System.Data.ForeignKeyConstraint("OrdersOrder_x0020_Details", New System.Data.DataColumn() { Me.tableOrders.OrderIDColumn}, New System.Data.DataColumn() { Me.tableOrder_Details.OrderIDColumn})
			Me.tableOrder_Details.Constraints.Add(fkc)
			fkc.AcceptRejectRule = System.Data.AcceptRejectRule.None
			fkc.DeleteRule = System.Data.Rule.Cascade
			fkc.UpdateRule = System.Data.Rule.Cascade
			Me.relationOrdersOrder_x0020_Details = New System.Data.DataRelation("OrdersOrder_x0020_Details", New System.Data.DataColumn() { Me.tableOrders.OrderIDColumn}, New System.Data.DataColumn() { Me.tableOrder_Details.OrderIDColumn}, False)
		...
		Partial Public Class Order_DetailsDataTable
			...
			<System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddOrder_DetailsRow(ByVal Discount As Single, ByVal parentOrdersRowByOrdersOrder_x0020_Details As OrdersRow, ByVal ProductID As Integer, ByVal Quantity As Short, ByVal UnitPrice As Decimal) As Order_DetailsRow
				Dim rowOrder_DetailsRow As Order_DetailsRow = (CType(Me.NewRow(), Order_DetailsRow))
				rowOrder_DetailsRow.ItemArray = New Object() { Discount, parentOrdersRowByOrdersOrder_x0020_Details(4), ProductID, Quantity, UnitPrice}
		...
		Partial Public Class OrdersDataTable
			...
			Public Function AddOrdersRow(ByVal CustomerID As String, ByVal EmployeeID As Integer, ByVal Freight As Decimal, ByVal OrderDate As System.DateTime, ByVal RequiredDate As System.DateTime, ByVal ShipAddress As String, ByVal ShipCity As String, ByVal ShipCountry As String, ByVal ShipName As String, ByVal ShippedDate As System.DateTime, ByVal ShipPostalCode As String, ByVal ShipRegion As String, ByVal ShipVia As Integer) As OrdersRow
				...
				rowOrdersRow.ItemArray = New Object() { CustomerID, EmployeeID, Freight, OrderDate, Nothing, RequiredDate, ShipAddress, ShipCity, ShipCountry, ShipName, ShippedDate, ShipPostalCode, ShipRegion, ShipVia}
		...
		Partial Public Class OrdersRow
			...
			Public Function GetOrder_DetailsRows() As Order_DetailsRow()
				Return (CType(MyBase.GetChildRows(Me.Table.ChildRelations("OrdersOrder_x0020_Details")), Order_DetailsRow()))
			End Function
		End Class
