...
Partial Public Class DataSet1
    ...
    Partial Public Class OrdersDataTable
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddOrdersRow(ByVal parentCustomersRowByCustomersOrders As CustomersRow, ByVal EmployeeID As Integer, ByVal Freight As Decimal, ByVal OrderDate As Date, ByVal RequiredDate As Date, ByVal ShipAddress As String, ByVal ShipCity As String, ByVal ShipCountry As String, ByVal ShipName As String, ByVal ShippedDate As Date, ByVal ShipPostalCode As String, ByVal ShipRegion As String, ByVal ShipVia As Integer) As OrdersRow
