...
Public Class Form1
    ...
    Private dataSet11 As ResizableRows.DataSet1
    ''' <summary>
...
#End If
        ...
        AddHandler gridGroupingControl1.TableControlResizingRows, AddressOf gridGroupingControl1_TableControlResizingRows
    ...
    Private Sub gridGroupingControl1_TableControlResizingRows(ByVal sender As Object, ByVal e As GridTableControlResizingRowsEventArgs)
        ...
        ' to be 0.
        If e.Inner.Reason = GridResizeCellsReason.MouseUp Then
            e.TableControl.Model.RowHeights.SetRange(e.Inner.Rows.Top, e.Inner.Rows.Bottom, e.Inner.Height)
            e.Inner.Cancel = True
        ElseIf e.Inner.Reason = GridResizeCellsReason.DoubleClick Then
...
#Region "Windows Form Designer generated code"
    ...
    Private Sub InitializeComponent()
        ...
        Me.dataSet11 = New ResizableRows.DataSet1
        ...
        Me.gridGroupingControl1.GridVisualStyles = Syncfusion.Windows.Forms.GridVisualStyles.Metro
        Me.gridGroupingControl1.Location = New System.Drawing.Point(15, 12)
        Me.gridGroupingControl1.Name = "gridGroupingControl1"
        Me.gridGroupingControl1.ShowGroupDropArea = True
        Me.gridGroupingControl1.Size = New System.Drawing.Size(673, 362)
    ...
    Private Sub gridGroupingControl1_TableControlCellClick(ByVal sender As Object, ByVal e As GridTableControlCellClickEventArgs)
        ...
        If id.TableCellType = GridTableCellType.ColumnHeaderCell Then
            ...
            If r.RaiseHitTest(e.Inner.RowIndex, e.Inner.ColIndex, e.Inner.MouseEventArgs, Nothing) = GridHitTestContext.CellButtonElement Then
                Dim column As String = IIf(Not (id.Column Is Nothing), id.Column.ToString(), "")  'TODO: For performance reasons this should be changed to nested IF statements
