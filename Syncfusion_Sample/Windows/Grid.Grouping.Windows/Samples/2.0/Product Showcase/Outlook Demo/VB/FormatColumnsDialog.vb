...
Namespace OutlookDemo
	...
	''' </summary>
	Public Class FormatColumnsDialog
		...
		Public Sub New(ByVal grid As GridGroupingControl)
			...
			For i As Integer = 1 To Me.groupingGrid.TableDescriptor.VisibleColumns.Count - 1
...
'			Me.radioButton3.CheckedChanged += New System.EventHandler(Me.radioButton3_CheckedChanged)
			...
			' tabPageAdv1
			' 
			Me.tabPageAdv1.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(215))))), (CInt(Fix((CByte(215))))), (CInt(Fix((CByte(229))))))
...
'			Me.checkBox1.CheckedChanged += New System.EventHandler(Me.checkBox1_CheckedChanged)
			...
			' tabPageAdv2
			' 
			Me.tabPageAdv2.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(215))))), (CInt(Fix((CByte(215))))), (CInt(Fix((CByte(229))))))
			...
			' tabPageAdv3
			' 
			Me.tabPageAdv3.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(215))))), (CInt(Fix((CByte(215))))), (CInt(Fix((CByte(229))))))
			...
			' gradientPanel1
			' 
			Me.gradientPanel1.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(246))))), (CInt(Fix((CByte(246))))), (CInt(Fix((CByte(252))))))
...
'			Me.btnNew.Click += New System.EventHandler(Me.btnNew_Click)
			...
			Me.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(209))))), (CInt(Fix((CByte(209))))), (CInt(Fix((CByte(223))))))
					...
					If des.Name.CompareTo(Me.listBox1.SelectedItem.ToString())=0 Then
						If des IsNot Nothing Then
							...
							If des.Appearance.AnyRecordFieldCell.HorizontalAlignment=GridHorizontalAlignment.Left Then
								Me.radioButton1.Checked=True
							ElseIf des.Appearance.AnyRecordFieldCell.HorizontalAlignment=GridHorizontalAlignment.Center Then
		...
		Private Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click
			...
			Else
				...
				Next des
				If Not flag Then
					Dim desc1 As New GridColumnDescriptor(descName)
					descColl.Add(desc1)
