...
'			Me.button1.Click += New System.EventHandler(Me.button1_Click)
		...
		Private Sub btnAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAdd.Click
			If Me.comboBox1.SelectedItem IsNot Nothing AndAlso Me.comboBox2.SelectedItem IsNot Nothing AndAlso Me.txtValue.TextLength<>0 Then
		...
		Private Sub btnRemove_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRemove.Click
			If (Me.listBox1.Items.Count>0) AndAlso (Me.listBox1.SelectedItem IsNot Nothing) Then
				Me.listBox1.Items.Remove(Me.listBox1.SelectedItem)
			End If
		End Sub

		Private Sub button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles button1.Click
			Dim criteria As New System.Text.StringBuilder()
		...
		Private Function CompareOp(ByVal s As String) As FilterCompareOperator
			...
			ElseIf s.CompareTo("Greater Than")=0 Then
				Return FilterCompareOperator.GreaterThan
			ElseIf s.CompareTo("Greater ThanOrEqualTo")=0 Then
				Return FilterCompareOperator.GreaterThanOrEqualTo
			ElseIf s.CompareTo("Less Than")=0 Then
				Return FilterCompareOperator.LessThan
			ElseIf s.CompareTo("Less ThanOrEqualTo")=0 Then
				Return FilterCompareOperator.LessThanOrEqualTo
			ElseIf s.CompareTo("Like")=0 Then
