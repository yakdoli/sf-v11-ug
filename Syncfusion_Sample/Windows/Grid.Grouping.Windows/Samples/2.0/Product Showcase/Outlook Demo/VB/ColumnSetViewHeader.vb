...
Namespace OutlookDemo
	...
	''' </summary>
	Public Class ColumnSetViewHeader
		...
		Public Sub New()
			...
			InitializeComponent()
			Me.gridControl1.ThemesEnabled = False
			...
			AddHandler gridControl1.QueryColWidth, AddressOf gridControl1_QueryColWidth
...
'			Me.gridControl1.CellClick += New Syncfusion.Windows.Forms.Grid.GridCellClickEventHandler(Me.gridControl1_CellClick)
			' 
			' panel1
			' 
...
'INSTANT VB NOTE: The variable pane was renamed since Visual Basic does not allow class members with the same name:
