...
'			Me.okButton.Click += New System.EventHandler(Me.okButton_Click)
			...
			' cancelButton
			' 
			Me.cancelButton_Renamed.Location = New System.Drawing.Point(232, 144)
...
'			Me.checkedListBox1.SelectedIndexChanged += New System.EventHandler(Me.checkedListBox1_SelectedIndexChanged)
			...
			Me.Controls.AddRange(New System.Windows.Forms.Control() { Me.checkedListBox1, Me.cancelButton_Renamed, Me.okButton, Me.resetButton, Me.downButton, Me.upButton, Me.label2, Me.label1})
		...
		Private Sub okButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles okButton.Click
			...
			Dim itemstore(Me.mainForm.GroupBarControl.GroupBarItems.Count - 1) As GroupBarItem
			...
			For i As Integer = 0 To Me.checkedListBox1.Items.Count - 1
				Dim itemtext As String = TryCast(Me.checkedListBox1.Items(i), String)
				If itemtext IsNot itemstore(i).Text Then
					Dim currentitem As GroupBarItem = itemstore(i)
					For newitempos As Integer = 0 To Me.checkedListBox1.Items.Count - 1
			...
			If breinsertitems = True Then
				...
				For i As Integer = 0 To itemstore.GetLength(0) - 1
		...
		Private Sub resetButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles resetButton.Click
			...
			Do While itemsenumerator.MoveNext()
				Dim itemstate As GroupBarItemState = TryCast(itemsenumerator.Current, GroupBarItemState)
