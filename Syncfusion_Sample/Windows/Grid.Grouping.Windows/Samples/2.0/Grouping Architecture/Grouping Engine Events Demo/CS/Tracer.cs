...
namespace GroupingEngineEventsTracer
{
	...
	public class Tracer
	{
		...
		public void HookEngTableEvents()
		{
			...
			this.groupingEngine.Table.CategorizingRecords+=new TableEventHandler(Table_CategorizingRecords);
		...
		private void Table_CategorizingRecords(object sender, TableEventArgs e)
		{
