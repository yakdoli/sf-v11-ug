...
namespace SortingMethods_2003 {
    ...
    public class Dataset1 : DataSet {
        ...
        public class CustomersDataTable : DataTable, System.Collections.IEnumerable {
            ...
            public CustomersRow AddCustomersRow(string CustomerID, string CompanyName, string ContactName, string ContactTitle, string Address, string City, string Country) {
