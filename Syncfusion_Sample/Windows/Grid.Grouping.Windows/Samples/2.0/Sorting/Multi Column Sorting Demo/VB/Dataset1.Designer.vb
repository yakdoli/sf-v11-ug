...
Namespace MultiColumnSorting_GGC
	...
	Partial Public Class Dataset1
		...
		Partial Public Class ProductsDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddProductsRow(ByVal ProductName As String, ByVal QuantityPerUnit As String, ByVal UnitPrice As Decimal, ByVal UnitsInStock As Short, ByVal UnitsOnOrder As Short) As ProductsRow
				Dim rowProductsRow As ProductsRow = (CType(Me.NewRow(), ProductsRow))
				Dim columnValuesArray() As Object = { Nothing, ProductName, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder}
			...
			Private Sub InitClass()
				...
				Me.Constraints.Add(New Global.System.Data.UniqueConstraint("Dataset1Key1", New Global.System.Data.DataColumn() { Me.columnProductID}, True))
