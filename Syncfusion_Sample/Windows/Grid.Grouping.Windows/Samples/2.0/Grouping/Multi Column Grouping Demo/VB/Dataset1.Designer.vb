...
Partial Public Class Dataset1
    ...
    Partial Public Class EmployeesDataTable
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddEmployeesRow(ByVal LastName As String, ByVal FirstName As String, ByVal Title As String, ByVal Address As String, ByVal City As String, ByVal Country As String) As EmployeesRow
