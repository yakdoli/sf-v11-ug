...
Namespace GroupingEvents
	Public Class EngineEventTracer
		...
		Private Sub AppendOutput(ByVal name As String, ByVal e As String)
		...
		Public Sub HookEvents()
            ...
            AddHandler groupingEngine.GroupingControl.FieldChooserShowing, AddressOf GroupingControl_FieldChooserShowing
            AddHandler groupingEngine.GroupingControl.FieldChooserShown, AddressOf GroupingControl_FieldChooserShown
            AddHandler groupingEngine.GroupingControl.FieldChooserClosing, AddressOf GroupingControl_FieldChooserClosing
            AddHandler groupingEngine.GroupingControl.FieldChooserClosed, AddressOf GroupingControl_FieldChooserClosed
            AddHandler groupingEngine.TableDescriptor.GroupedColumns.Changing, AddressOf GroupedColumns_Changing
		...
		Public Sub UnhookEvents()
            ...
            RemoveHandler groupingEngine.GroupingControl.FieldChooserShowing, AddressOf GroupingControl_FieldChooserShowing
            RemoveHandler groupingEngine.GroupingControl.FieldChooserShown, AddressOf GroupingControl_FieldChooserShown
            RemoveHandler groupingEngine.GroupingControl.FieldChooserClosing, AddressOf GroupingControl_FieldChooserClosing
            RemoveHandler groupingEngine.GroupingControl.FieldChooserClosed, AddressOf GroupingControl_FieldChooserClosed
            RemoveHandler groupingEngine.TableDescriptor.GroupedColumns.Changing, AddressOf GroupedColumns_Changing
		...
		Private Sub groupingEngine_SortedItemsInGroup(ByVal sender As Object, ByVal e As GroupEventArgs)
            If Not e.Group.Category Is Nothing Then
        ...
        Private Sub GroupedColumns_Changed(ByVal sender As Object, ByVal e As Syncfusion.Collections.ListPropertyChangedEventArgs)
            If e.Action = Syncfusion.Collections.ListPropertyChangedType.Insert Then
