...
Namespace Grouping_GGC
	...
	Public Class Dataset1 : Inherits DataSet
		...
		Public Class EmployeesDataTable : Inherits DataTable : Implements System.Collections.IEnumerable
			...
			Public Function AddEmployeesRow(ByVal LastName As String, ByVal FirstName As String, ByVal Title As String, ByVal BirthDate As System.DateTime, ByVal HireDate As System.DateTime, ByVal Address As String, ByVal City As String, ByVal Region As String, ByVal PostalCode As String, ByVal Country As String, ByVal HomePhone As String) As EmployeesRow
				Dim rowEmployeesRow As EmployeesRow = (CType(Me.NewRow(), EmployeesRow))
				rowEmployeesRow.ItemArray = New Object() { Nothing, LastName, FirstName, Title, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone}
