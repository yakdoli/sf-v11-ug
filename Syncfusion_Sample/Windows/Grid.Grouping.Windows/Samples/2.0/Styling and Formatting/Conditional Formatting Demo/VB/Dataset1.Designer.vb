...
Namespace GridConditionalFormatDescriptor_GGC
	...
	Partial Public Class Dataset1
		...
		Partial Public Class CustomersDataTable
			...
			<System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddCustomersRow(ByVal CustomerID As String, ByVal CompanyName As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal Region As String, ByVal PostalCode As String, ByVal Country As String, ByVal Phone As String) As CustomersRow
				Dim rowCustomersRow As CustomersRow = (CType(Me.NewRow(), CustomersRow))
				rowCustomersRow.ItemArray = New Object() { CustomerID, CompanyName, ContactName, ContactTitle, Region, PostalCode, Country, Phone}
			...
			Private Sub InitClass()
				...
				Me.Constraints.Add(New System.Data.UniqueConstraint("Dataset1Key1", New System.Data.DataColumn() { Me.columnCustomerID}, True))
