...
Namespace DynamicFormatting_GGC
	...
	Partial Public Class Dataset1
		...
		Partial Public Class OrdersDataTable
			...
			<System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddOrdersRow(ByVal OrderDate As System.DateTime, ByVal RequiredDate As System.DateTime, ByVal ShippedDate As System.DateTime, ByVal ShipVia As Integer, ByVal Freight As Decimal, ByVal ShipName As String, ByVal ShipPostalCode As String, ByVal ShipCountry As String) As OrdersRow
				Dim rowOrdersRow As OrdersRow = (CType(Me.NewRow(), OrdersRow))
				rowOrdersRow.ItemArray = New Object() { Nothing, OrderDate, RequiredDate, ShippedDate, ShipVia, Freight, ShipName, ShipPostalCode, ShipCountry}
			...
			Private Sub InitClass()
				...
				Me.Constraints.Add(New System.Data.UniqueConstraint("Dataset1Key1", New System.Data.DataColumn() { Me.columnOrderID}, True))
