...
Namespace ChartWaterMarker
	Public Class ChartAppearance
		...
		Public Shared Sub ApplyChartStyles(ByVal chart As ChartControl)
			...
			chart.CustomPalette = New System.Drawing.Color() { Color.FromArgb(200, 41,122,139), Color.FromArgb(200, 140,198,62), Color.FromArgb(200,247,148,29), Color.FromArgb(200, 163,48,45) }
...
'			#Region "Chart Appearance Customization"
			...
			chart.ChartInterior = New BrushInfo(GradientStyle.PathEllipse, Color.FromArgb(215, 228, 189), Color.White)
