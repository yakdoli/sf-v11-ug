...
Namespace AxisLabelBinding
	Public Class Form1
        ...
        Private color As Color() = New Color() {System.Drawing.Color.FromArgb(117, 142, 172), System.Drawing.Color.FromArgb(205, 217, 231), System.Drawing.Color.FromArgb(117, 142, 172)}
		...
		Private Sub InitializeComponent()
            ...
            Me.chartControl1.Size = New System.Drawing.Size(488, 351)
            ...
            Me.panel2.Location = New System.Drawing.Point(268, 307)
            ...
            Me.comboBox1.Items.AddRange(New Object() {"Column", "Pie", "Funnel"})
            Me.comboBox1.Location = New System.Drawing.Point(77, 381)
            ...
            Me.ClientSize = New System.Drawing.Size(542, 460)
		...
		Protected Sub InitializeChartData()
			...
			Me.chartControl1.AllowGradientPalette = True
			...
			Me.chartControl1.PrimaryXAxis.CustomLabelsParameter = ChartCustomLabelsParameter.Position
...
#End Region
		...
		Private Sub comboBox1_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles comboBox1.SelectedIndexChanged
            ...
            If comboBox1.SelectedIndex = 0 Then
                Me.chartControl1.Series(0).Style.DisplayText = False
            End If
			...
			If comboBox1.SelectedIndex = 1 Then
				...
				Me.chartControl1.Series(0).ConfigItems.PieItem.ShowDataBindLabels = True
				Me.chartControl1.Series(0).ConfigItems.PieItem.LabelStyle = ChartAccumulationLabelStyle.OutsideInColumn
			End If
		End Sub
		#End Region
	End Class
