...
Partial Public Class DataSet1
    ...
    Partial Public Class CustomersDataTable
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddCustomersRow(ByVal ContactName As String, ByVal CompanyName As String, ByVal Address As String, ByVal City As String, ByVal Country As String) As CustomersRow
