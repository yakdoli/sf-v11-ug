...
Public Class GridNonVirtualDataCache
    Implements IGridVolatileData 'ToDo: Add Implements Clauses for implementation methods of these interface(s)
    '/ <summary>
    ...
    Private _gridModel As GridModel
        ...
        Get
            ...
            If style Is Nothing Then
                ...
                If store Is Nothing Then
                    ...
                    If rowIndex <= _gridModel.Data.RowCount AndAlso colIndex <= _gridModel.Data.ColCount Then
...
#End Region
    ...
    Public Class RowStylesIndexer
        Private _dataCacheParent As GridNonVirtualDataCache
        
        Friend Sub New(_dataCache As GridNonVirtualDataCache)
    ...
    Public Class ColStylesIndexer
        ...
        Friend Sub New(ByVal _dataCache As GridNonVirtualDataCache)
            _dataCacheParent = _dataCache
        End Sub 'New

        Default Public Property Item(ByVal colIndex As Integer) As GridStyleInfo
            Get
    ...
    Public Class GridStyleInfoCache
        ...
        '/ <returns></returns>
        Public Function Contains(ByVal rowIndex As Integer, ByVal colIndex As Integer) As Boolean
        ...
        Default Public Property Item(ByVal rowIndex As Integer, ByVal colIndex As Integer) As GridStyleInfo
            Get
...
End Class 'GridNonVirtualDataCache