...
Namespace Overview
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.overviewControl1 = New Syncfusion.Windows.Forms.Diagram.Controls.OverviewControl(Me.components)
			...
			' overviewControl1
			' 
			Me.overviewControl1.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(251))))), (CInt(Fix((CByte(251))))), (CInt(Fix((CByte(251))))))
			Me.overviewControl1.Diagram = Nothing
			Me.overviewControl1.Dock = System.Windows.Forms.DockStyle.Fill
			Me.overviewControl1.ForeColor = System.Drawing.Color.Red
			Me.overviewControl1.Location = New System.Drawing.Point(10, 10)
			Me.overviewControl1.Name = "overviewControl1"
			Me.overviewControl1.Size = New System.Drawing.Size(263, 620)
			Me.overviewControl1.TabIndex = 0
			' 
			' panel2
			' 
...
'			Me.Load += New System.EventHandler(Me.Form1_Load)
		...
		Private overviewControl1 As Syncfusion.Windows.Forms.Diagram.Controls.OverviewControl
	End Class
