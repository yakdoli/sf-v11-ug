            ...
            set
            {
                if (value != m_weatherCondition)
                {
                    ...
                    if (value == WeatherCondition.Rain)
                        m_imageNode.Image = (Bitmap)Image.FromFile("..//..//Data//Rain.png");
                    else if (value == WeatherCondition.ThunderStorm)
                        m_imageNode.Image = (Bitmap)Image.FromFile("..//..//Data//Thunder.png");
                    else if (value == WeatherCondition.Snow)
                        m_imageNode.Image = (Bitmap)Image.FromFile("..//..//Data//Snow.png");
                    else if (value == WeatherCondition.None)
                        m_imageNode.Image = (Bitmap)Image.FromFile("..//..//Data//Sunny.png");
