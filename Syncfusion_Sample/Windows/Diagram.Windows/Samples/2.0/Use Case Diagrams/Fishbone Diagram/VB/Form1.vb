...
#Region "Form initialize"
        Public Sub New()
            ...
            fileName = "..\..\..\..\..\..\..\..\..\Common\Data\Diagram\FishBone Diagram.edd"
            diagram1.LoadBinary("..\..\..\..\..\..\..\..\..\Common\Data\Diagram\FishBone Diagram.edd")
            paletteGroupBar1.LoadPalette("..\..\..\..\..\..\..\..\..\Common\Data\Diagram\FishboneSymbols.edp")
            GroupBarAppearance()
            diagram1.EndUpdate()
...
#Region "MenuTools"
        ...
        Private Sub zoomInToolStripButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles zoomInToolStripMenuItem.Click
            diagram1.View.ZoomIn()
        End Sub

        Private Sub zoomOutToolStripButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles zoomOutToolStripMenuItem.Click
            diagram1.View.ZoomOut()
        End Sub

        Private Sub pageSettingsToolStripButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles toolStripButton4.Click
            If Me.diagram1 IsNot Nothing AndAlso Me.diagram1.Model IsNot Nothing Then
        ...
        Private Sub previewToolStripButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles toolStripButton3.Click
        ...
        Private Sub printToolStripButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles toolStripButton2.Click
            If Me.diagram1 IsNot Nothing Then
                Dim printDoc As PrintDocument = Me.diagram1.CreatePrintDocument()
        ...
        Private Sub rulerToolStripButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles rulerToolStripButton.Click
            Me.diagram1.ShowRulers = Not Me.diagram1.ShowRulers
        ...
        Private Sub zoomInToolStripMenuItem_Click(ByVal sender As Object, ByVal e As EventArgs)
            diagram1.View.ZoomIn()
        End Sub

        Private Sub zoomOutToolStripMenuItem_Click(ByVal sender As Object, ByVal e As EventArgs)
            diagram1.View.ZoomOut()
        End Sub
        ...
        Private Sub fillStyleToolStripButton1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles fillStyleToolStripButton1.Click
