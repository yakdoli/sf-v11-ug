...
#End Region
        ...
        Private Sub Office2007Blue_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles Office2007Blue.CheckChanged
            Me.pivotGridControl1.GridVisualStyles = Syncfusion.Windows.Forms.GridVisualStyles.Office2007Blue
        End Sub

        Private Sub Office2007Black_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles Office2007Black.CheckChanged
            Me.pivotGridControl1.GridVisualStyles = Syncfusion.Windows.Forms.GridVisualStyles.Office2007Black
        End Sub

        Private Sub Office2007Silver_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles Office2007Silver.CheckChanged
            Me.pivotGridControl1.GridVisualStyles = Syncfusion.Windows.Forms.GridVisualStyles.Office2007Silver
        End Sub

        Private Sub Office2010Blue_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles Office2010Blue.CheckChanged
            Me.pivotGridControl1.GridVisualStyles = Syncfusion.Windows.Forms.GridVisualStyles.Office2010Blue
        End Sub

        Private Sub Office2010Black_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles Office2010Black.CheckChanged
            Me.pivotGridControl1.GridVisualStyles = Syncfusion.Windows.Forms.GridVisualStyles.Office2010Black
        End Sub

        Private Sub Office2010Silver_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles Office2010Silver.CheckChanged
            Me.pivotGridControl1.GridVisualStyles = Syncfusion.Windows.Forms.GridVisualStyles.Office2010Silver
        End Sub

        Private Sub Metro_CheckChanged(ByVal sender As Object, ByVal e As EventArgs) Handles Metro.CheckChanged
