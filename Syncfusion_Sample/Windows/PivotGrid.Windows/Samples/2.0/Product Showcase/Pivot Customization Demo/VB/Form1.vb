...
Namespace WindowsFormsApplication11
	Partial Public Class Form1
		...
		Public Class ProductSales
			...
			Public Shared Function GetSalesData() As ProductSalesCollection
				...
				For i As Integer = 0 To numberOfRecords - 1
					...
					Dim discount As Double = (3000 * sales.Quantity) * (Double.Parse(sales.Quantity.ToString()) / 100)
		...
		Private Sub checkBox2_CheckStateChanged(ByVal sender As Object, ByVal e As EventArgs) Handles checkBox2.CheckStateChanged
			Me.pivotGridControl1.ShowSubTotals = Not Me.pivotGridControl1.ShowSubTotals
		End Sub

		Private Sub checkBox3_CheckStateChanged(ByVal sender As Object, ByVal e As EventArgs) Handles checkBox3.CheckStateChanged
			Me.pivotGridControl1.ShowGrandTotals = Not Me.pivotGridControl1.ShowGrandTotals
		End Sub
		...
		Private Sub checkBoxAdv1_CheckStateChanged(ByVal sender As Object, ByVal e As EventArgs) Handles checkBoxAdv1.CheckStateChanged
			Me.pivotGridControl1.SuspendLayout()
			Me.pivotGridControl1.ShowPivotTableFieldList = Not Me.pivotGridControl1.ShowPivotTableFieldList
			Me.pivotGridControl1.ResumeLayout(True)
		...
		Private Sub checkBoxAdv2_CheckStateChanged(ByVal sender As Object, ByVal e As EventArgs) Handles checkBoxAdv2.CheckStateChanged
			...
			Else
				Me.pivotGridControl1.RightToLeft = RightToLeft.No
			End If
			LockWindowUpdate(IntPtr.Zero)
			Me.pivotGridControl1.TableControl.Refresh()
			Me.pivotGridControl1.PivotSchemaDesigner.Refresh()
			Me.pivotGridControl1.Refresh()
		End Sub
	End Class
End Namespace
