...
namespace PivotGridDemo
{
    public partial class Form1 : MetroForm
    {
        ...
        {
            InitializeComponent();
            this.pivotGridControl1.TableControl.ThemesEnabled = true;
            ...
            this.pivotGridControl1.TableModel.QueryCellInfo += new GridQueryCellInfoEventHandler(TableModel_QueryCellInfo);
            this.pivotGridControl1.TableControl.CellClick += new GridCellClickEventHandler(TableControl_CellClick);
        }
        ...
        {
            PivotCellInfo pivotcell = this.pivotGridControl1.PivotEngine[e.RowIndex - 1, e.ColIndex - 1];
        }
