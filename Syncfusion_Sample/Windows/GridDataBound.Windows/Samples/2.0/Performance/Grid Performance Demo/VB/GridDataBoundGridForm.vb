...
Namespace GridDataBoundGridPerf
    ...
    Public Class GridDataBoundGridForm
        ...
        Private grid As GridDataBoundGrid
        ...
        Private WithEvents buttonInfo As Syncfusion.Windows.Forms.ButtonAdv
        ...
        Sub LogMemoryUsage()
            If Not (grid Is Nothing) Then
                Me.textBox1.Text += String.Format("Total Row Count {0}" + vbCr + vbLf, grid.Model.RowCount)
            End If
...
#End If
        ...
        Private Sub InitializeGrid()
            ...
            Me.grid.ForceUpdateAfterListChangedEvent = False

            ' Use ScrollWindow operations instead of invalidating whole grid when
            ' inserting or removing records.
            Me.grid.OptimizeInsertRemoveCells = optimizeScrolling
            ...
            Me.grid.Binder.EnableAddNew = False
            ...
            Me.grid.AllowResizeToFit = Not Me.calculateMaxColumnWidth
            If Me.calculateMaxColumnWidth Then
                Me.grid.Model.ColWidths.ResizeToFit(Me.grid.ViewLayout.VisibleCellsRange, GridResizeToFitOptions.NoShrinkSize)
            End If
            ...
            Dim settings As String = String.Format("OptimizedListChanged={0}" + vbTab + "DataTableList={1}" + vbTab + "Autosize={2}" + vbTab + "ScrollWindow={3}" + vbCr + vbLf, useOptimizedListChangedEvent, useDataTableList, Me.calculateMaxColumnWidth, optimizeScrolling)
            ...
            Dim time4 As String = String.Format("Repaint/Sizing: {0}" + vbCr + vbLf, dtPaint.Subtract(dtCount))
...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Me.buttonInfo = New Syncfusion.Windows.Forms.ButtonAdv
            ...
            Me.gridPanel.Size = New System.Drawing.Size(552, 352)
            ...
            Me.btnInitGrid.Location = New System.Drawing.Point(33, 187)
            ...
            Me.btnResetGrid.Location = New System.Drawing.Point(695, 202)
            ...
            Me.textBox1.Size = New System.Drawing.Size(552, 160)
            ...
            Me.labelRecordCount.Location = New System.Drawing.Point(599, 46)
            ...
            Me.labelZipCount.Location = New System.Drawing.Point(600, 68)
            ...
            Me.checkBoxCalculateMaximumWidth.Location = New System.Drawing.Point(600, 144)
            ...
            Me.checkBoxUseDataViewSort.Location = New System.Drawing.Point(600, 168)
            ...
            Me.textBoxRecordCount.Location = New System.Drawing.Point(687, 48)
            ...
            Me.textBoxZipCount.Location = New System.Drawing.Point(687, 72)
            ...
            Me.label1.Location = New System.Drawing.Point(599, 314)
            ...
            Me.textBoxRepeatCount.Location = New System.Drawing.Point(688, 313)
            ...
            Me.buttonInsertRecords.Location = New System.Drawing.Point(61, 166)
            ...
            Me.buttonRemoveRecords.Location = New System.Drawing.Point(61, 138)
            ...
            Me.buttonChangeRecords.Location = New System.Drawing.Point(61, 194)
            ...
            Me.checkBoxUseOptimizedListChangedEvent.Location = New System.Drawing.Point(600, 120)
            ...
            Me.checkBoxUseScrollWindow.Location = New System.Drawing.Point(17, 102)
            ...
            Me.grpInitializeTable.Controls.Add(Me.buttonInfo)
            ...
            Me.grpInitializeTable.Location = New System.Drawing.Point(584, 16)
            ...
            'buttonInfo
            '
            Me.buttonInfo.Appearance = Syncfusion.Windows.Forms.ButtonAppearance.Office2007
            ...
            Me.buttonInfo.ForeColor = System.Drawing.SystemColors.ControlText
            Me.buttonInfo.Location = New System.Drawing.Point(70, 216)
            Me.buttonInfo.Name = "buttonInfo"
            Me.buttonInfo.Size = New System.Drawing.Size(80, 23)
            Me.buttonInfo.TabIndex = 2
            Me.buttonInfo.Text = "Information"
            Me.buttonInfo.UseVisualStyle = True
            '
            'grpgroupBox1
            '
            ...
            Me.grpgroupBox1.Location = New System.Drawing.Point(584, 280)
            ...
            Me.btnChangeNames.Location = New System.Drawing.Point(61, 222)
            ...
            Me.txtBatchSize.Location = New System.Drawing.Point(104, 56)
            ...
            Me.lbllabel2.Location = New System.Drawing.Point(15, 58)
            ...
            Me.panel1.Size = New System.Drawing.Size(800, 566)
            ...
            Me.Name = "GridDataBoundGridForm"
            Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
            Me.Text = "GDBG Performance Demo"
...
#End Region
        ...
        Private Sub buttonInsertRecords_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles buttonInsertRecords.Click
            ...
            Dim time0 As String = String.Format("useWindowScroll={0}" + vbCr + vbLf, Me.optimizeScrolling)
            Dim time1 As String = String.Format("Inserted {0} Records: {1}" + vbCr + vbLf, repeatCount, dtEnd.Subtract(dtStart))
            Me.textBox1.Text += vbCr + vbLf + vbCr + vbLf + time0 + time1.ToString
            Me.LogMemoryUsage()
        ...
        Private Sub buttonInfo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles buttonInfo.Click
            Dim s As String = "RecordCount - total records in DataTable" + vbCr + vbLf + "Zip Count - number of unique zip code entries in the data - used for grouping" + vbCr + vbLf + "OptimizedListChanged event - uses ListChanged instead of CurrencyManager events" + vbCr + vbLf + "ResizeToFit - whether the visible grid should have columns sized so data is visible" + vbCr + vbLf + "DataTableList - IBindingList wrapper for DataViews to avoid some deficiencies" + vbCr + vbLf + "RepeatCount - number of Removes, Inserts, or Changes (total times through loop)" + vbCr + vbLf + "Batch Size - grid.Update() called after this many loop iterations" + vbCr + vbLf + "Use ScrollWindow - When row is inserted/deleted, then optimally paint the screen using ScrollWindow" + vbCr + vbLf

            Dim f As New GridPerf.InfoForm()
            f.TextLabel.Text = s
            f.ShowDialog()
        End Sub 'buttonInfo_Click
    End Class 'GridDataBoundGridForm
End Namespace 'GridDataBoundGridPerf
