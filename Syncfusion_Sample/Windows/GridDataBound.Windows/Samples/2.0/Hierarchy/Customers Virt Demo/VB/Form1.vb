...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Me.gridRecordNavigationControl1.Size = New System.Drawing.Size(544, 176)
            ...
            Me.gridDataBoundGrid1.Size = New System.Drawing.Size(523, 155)
            ...
            Me.okButton.Location = New System.Drawing.Point(408, 398)
            ...
            Me._cancelButton.Location = New System.Drawing.Point(496, 398)
            ...
            Me.dataGrid1.Location = New System.Drawing.Point(24, 232)
            Me.dataGrid1.Name = "dataGrid1"
            Me.dataGrid1.Size = New System.Drawing.Size(544, 160)
            ...
            Me.panel1.Size = New System.Drawing.Size(584, 438)
...
#End If
        ...
        Private Sub Form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Dim rob As New RecordObjectBinder(Me.gridDataBoundGrid1.Model) '

            Dim rootLevel As GridHierarchyLevel = binder.RootHierarchyLevel

            Dim gbc As New GridBoundColumnsCollection(Me.gridDataBoundGrid1.Binder)
            ...
            childrenLevel.GridBoundColumns = CType(gbc.Clone(), GridBoundColumnsCollection)
