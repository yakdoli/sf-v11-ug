...
# endif
        ...
        private void Form1_Load(object sender, System.EventArgs e)
        {
            ...
            this.gridDataBound1.DefaultGridBorderStyle = GridBorderStyle.Solid;
            ExcelTip.GridExcelTipStyleProperties style = new ExcelTip.GridExcelTipStyleProperties(this.gridDataBound1[2, 2]);
            style.ExcelTipText = "Comment for cell 2,2.";

            // Maintain an Arraylist to store the comments
            comments = new ArrayList();
            for (int i = 0; i <= this.gridDataBound1.Model.RowCount; i++)
            {
                this.comments.Add(null);
            }
            comments[1] = style.ExcelTipText;

            this.gridDataBound1.Model.QueryCellInfo += new GridQueryCellInfoEventHandler(Model_QueryCellInfo);
        }
