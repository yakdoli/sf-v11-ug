...
namespace GDBGwithDropGrids
{
	...
	/// </summary>
	public class GridHierDataBoundGrid : GridDataBoundGrid
	{
		public GridHierDataBoundGrid(Form f, DataTable parentTable, DataTable childTable, GridDataBoundGrid childGrid, QueryFilterStringEventHandler queryFilterHandler, QueryFormatGridEventHandler queryFormatHandler, bool hasChildGrid): base()
		{
			if(hasChildGrid)
			{
