...
namespace GDBGwithDropGrids
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private GridHierDataBoundGrid customerGrid1;
		private GridHierDataBoundGrid orderGrid2;
...
# endif		
		...
		private void Form1_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				this.order_DetailsGrid3 =  new GridHierDataBoundGrid(this, this.dataSet11.Order_Details,
				...
				// - will be shown in dropdown
				this.orderGrid2 =  new GridHierDataBoundGrid(this, this.dataSet11.Orders,
