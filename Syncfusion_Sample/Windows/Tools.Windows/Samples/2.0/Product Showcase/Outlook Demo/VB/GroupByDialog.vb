...
Namespace OutlookDemo
	...
	''' </summary>
	Public Class GroupByDialog : Inherits System.Windows.Forms.Form
		...
		Public Sub New(ByVal vCols As String())
			...
			InitializeComponent()
			Dim i As Integer=1
'ORIGINAL LINE: for(int i=1;i<vCols.Length;i += 1)
...
'			Me.radioButton3.CheckedChanged += New System.EventHandler(Me.radioButton3_CheckedChanged);
			...
			' comboBox2
			' 
			Me.comboBox2.BackColor = System.Drawing.Color.FromArgb((CInt((CByte(234)))), (CInt((CByte(242)))), (CInt((CByte(251)))))
...
'			Me.radioButton5.CheckedChanged += New System.EventHandler(Me.radioButton5_CheckedChanged);
			...
			' comboBox3
			' 
			Me.comboBox3.BackColor = System.Drawing.Color.FromArgb((CInt((CByte(234)))), (CInt((CByte(242)))), (CInt((CByte(251)))))
...
'			Me.button1.Click += New System.EventHandler(Me.button1_Click);
			...
			' comboBox4
			' 
			Me.comboBox4.BackColor = System.Drawing.Color.FromArgb((CInt((CByte(234)))), (CInt((CByte(242)))), (CInt((CByte(251)))))
			...
			Me.BackColor = System.Drawing.Color.FromArgb((CInt((CByte(227)))), (CInt((CByte(239)))), (CInt((CByte(255)))))
