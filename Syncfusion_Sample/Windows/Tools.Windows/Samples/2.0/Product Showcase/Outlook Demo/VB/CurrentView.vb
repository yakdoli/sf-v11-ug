...
Namespace OutlookDemo
	...
	''' </summary>
	Public Class CurrentView : Inherits System.Windows.Forms.Form
...
'			Me.button5.Click += New System.EventHandler(Me.button5_Click);
		...
		Private Sub SetFieldsLabel()
			Dim visibleCols As System.Text.StringBuilder = New System.Text.StringBuilder()
			Dim i As Integer = 0
...
'INSTANT VB NOTE: This 'for' loop was translated to a VB 'Do While' loop:
		...
		Private Sub SetGroupByLabel()
			Dim grps As System.Text.StringBuilder = New System.Text.StringBuilder()
		...
		Private Sub SetSortLabel()
			Dim sortCols As System.Text.StringBuilder = New System.Text.StringBuilder()
		...
		Private Sub SetFilterLabel()
			Dim filters As System.Text.StringBuilder = New System.Text.StringBuilder()
		...
		Private Sub button5_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles button5.Click
			Dim dlg As FormatColumnsDialog = New FormatColumnsDialog(Me.groupingGrid)
			dlg.ShowDialog()
		End Sub
	End Class
End Namespace
