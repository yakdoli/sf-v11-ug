...
Namespace OutlookDemo
	...
	''' </summary>
	Public Class ContactsPaneForm : Inherits System.Windows.Forms.UserControl
		...
		Public Sub New()
			...
			Dim unboundCol As GridColumnDescriptor = New GridColumnDescriptor("ImageCol", "", "", True, 30)
...
'INSTANT VB NOTE: This 'for' loop was translated to a VB 'Do While' loop:
			...
			Me.gridGroupingControl1.GridGroupDropArea.ThemesEnabled = True
            ...
            AddHandler Me.gridGroupingControl1.TableDescriptor.VisibleColumns.Changed, AddressOf VisibleColumns_Changed
            ...
            AddHandler Me.gridGroupingControl1.TableDescriptor.SortedColumns.Changed, AddressOf SortedColumns_Changed
		...
		Private Sub InitializeComponent()
			...
			Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ContactsPaneForm))
...
'			Me.barItem8.Click += New System.EventHandler(Me.barItem8_Click);
		...
		Private Sub SortedColumns_Changed(ByVal sender As Object, ByVal e As Syncfusion.Collections.ListPropertyChangedEventArgs)
			'string colName = this.gridGroupingControl1.TableDescriptor.SortedColumns[e.Index].Name;
			...
			'    this.gridGroupingControl1.TableModel.ColStyles[colName].BackColor = Color.FromArgb(242, 248, 255);
			'else if (e.Action == Syncfusion.Collections.ListPropertyChangedType.Remove)
			'    this.gridGroupingControl1.TableModel.ColStyles[colName].BackColor = Color.White;
...
'INSTANT VB NOTE: This 'for' loop was translated to a VB 'Do While' loop:
		...
		Private Sub barItem1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles barItem1.Click
			Dim dlg As NewContactDialog = New NewContactDialog()
		...
		Private Sub barItem3_Click(ByVal sender As Object, ByVal e As EventArgs) Handles barItem3.Click
			Dim dlg As GroupByDialog = New GroupByDialog(visibleCols)
			If dlg.ShowDialog() = DialogResult.OK Then
				...
				Else If dlg.View = "All collapsed" Then
...
'INSTANT VB NOTE: This 'for' loop was translated to a VB 'Do While' loop:
		...
		Private Sub barItem6_Click(ByVal sender As Object, ByVal e As EventArgs) Handles barItem6.Click
			Dim dlg As SortDialog = New SortDialog(visibleCols)
			If dlg.ShowDialog() = DialogResult.OK Then
				For i As Integer = 0 To 2
		...
		Private Sub barItem8_Click(ByVal sender As Object, ByVal e As EventArgs) Handles barItem8.Click
			Dim curView As CurrentView = New CurrentView(Me)
			curView.ShowDialog()
		End Sub

		Private Sub barItem7_Click(ByVal sender As Object, ByVal e As EventArgs) Handles barItem7.Click
			Dim dlg As FilterDialog = New FilterDialog(Me.gridGroupingControl1)
			dlg.ShowDialog()
		End Sub
			...
			If e.Inner.MouseEventArgs.Button = MouseButtons.Left Then
				If e.Inner.RowIndex > 1 Then
					...
					If style.TableCellIdentity.TableCellType = GridTableCellType.GroupCaptionPlusMinusCell Then
						Dim curGrp As GridCaptionRow = CType(IIf(TypeOf e.TableControl.Table.NestedDisplayElements(e.Inner.RowIndex) Is GridCaptionRow, e.TableControl.Table.NestedDisplayElements(e.Inner.RowIndex), Nothing), GridCaptionRow)
