...
#Region "Class"
    ...
    ''' </summary>
    Public Class GroupingPanel : Inherits System.Windows.Forms.Panel
...
#Region "dataTable"
        Private Function GetTable() As DataTable
            ...
            Dim dcAttachment As DataColumn = New DataColumn("Attachment")
            Dim dcFrom As DataColumn = New DataColumn("From")
            Dim dcSubject As DataColumn = New DataColumn("Subject")
            Dim dcReceived As DataColumn = New DataColumn("Received", GetType(DateTime))

            Dim dcMails As DataColumn = New DataColumn("mails", GetType(Integer))
            Dim dcReadState As DataColumn = New DataColumn("ReadState", GetType(Integer))
            Dim dcTo As DataColumn = New DataColumn("To")
            Dim dcContent As DataColumn = New DataColumn("Content")
            'DataColumn dcflag = new DataColumn("flag", typeof(int));
            Dim dcSize As DataColumn = New DataColumn("Size", GetType(Double))
            Dim dcPriority As DataColumn = New DataColumn("Priority")
            Dim dcCategory As DataColumn = New DataColumn("Category", GetType(String))
            Dim dcFlag As DataColumn = New DataColumn("flag", GetType(Integer))
            ...
            dt.Rows.Add(New Object() {String.Empty, "Cindy", "Eval version Key", DateTime.Now, 0, 0, "Jake", "Please provide me the key to the new version", 5010, String.Empty, "Red Category", CInt(flags.Red)})
            ...
            dt.Rows.Add(New Object() {String.Empty, "Ted", "User Account", DateTime.Now.AddHours(-3), 0, 0, "Jake", "User accounts have been created", 55000, 1, Nothing, CInt(flags.Clear)})
            ...
            dt.Rows.Add(New Object() {String.Empty, "George", "Installation Procedure", DateTime.Now.AddDays(-42), 2, 1, "Jake", "It is uploaded in server. Please go through this", 20400, String.Empty, Nothing, CInt(flags.Clear)})
...
#Region "Constructor"
        ...
        Public Sub New()
            ...
            Dim i As Integer = 0
            'ORIGINAL LINE: for (int i = 0; i < visibleCols.Length; i += 1)
            'INSTANT VB NOTE: This 'for' loop was translated to a VB 'Do While' loop:
            Do While i < visibleCols.Length
            ...
            Dim h As Integer = 0
            'ORIGINAL LINE: for (int h = 0; h < Me.headerParentBarItem.Items.Count; h += 1)
            'INSTANT VB NOTE: This 'for' loop was translated to a VB 'Do While' loop:
            Do While h < Me.headerParentBarItem.Items.Count
            ...
            AddHandler Me.gridGroupingControl1.GroupExpanded, AddressOf gridGroupingControl1_GroupExpanded
            AddHandler Me.gridGroupingControl1.GroupCollapsed, AddressOf gridGroupingControl1_GroupCollapsed
            ...
            'INSTANT VB NOTE: The local variable date was renamed since it is a keyword in VB:
            Dim date_Renamed As FieldDescriptor = New FieldDescriptor("date", "date", False, "")
            Me.gridGroupingControl1.TableDescriptor.UnboundFields.Add(date_Renamed)
            Dim cddate As GridColumnDescriptor = New GridColumnDescriptor(date_Renamed)
            ...
            Dim customSize As FieldDescriptor = New FieldDescriptor("customSize", "customSize", False, "")
            Me.gridGroupingControl1.TableDescriptor.UnboundFields.Add(customSize)
            Dim cdcustomSize As GridColumnDescriptor = New GridColumnDescriptor(customSize)
            ...
            Dim DummyCol As FieldDescriptor = New FieldDescriptor("DummyCol", "DummyCol", True, "")
            Me.gridGroupingControl1.TableDescriptor.UnboundFields.Add(DummyCol)
            Dim cdDummyCol As GridColumnDescriptor = New GridColumnDescriptor(DummyCol)
            ...
            AddHandler Me.gridGroupingControl1.TableModel.ColWidthsChanging, AddressOf TableModel_ColWidthsChanging
            AddHandler Me.gridGroupingControl1.TableModel.ColWidthsChanged, AddressOf TableModel_ColWidthsChanged
            ...
            AddHandler Me.gridGroupingControl1.QueryValue, AddressOf gridGroupingControl1_QueryValue
            AddHandler Me.gridGroupingControl1.TableModel.QueryCoveredRange, AddressOf TableModel_QueryCoveredRange
            ...
            AddHandler Me.gridGroupingControl1.TableControlKeyDown, AddressOf gridGroupingControl1_TableControlKeyDown
            ...
            AddHandler Me.gridGroupingControl1.TableControl.Model.SelectionChanging, AddressOf Model_SelectionChanging
            AddHandler Me.gridGroupingControl1.GridGroupDropArea.PrepareViewStyleInfo, AddressOf GridGroupDropArea_PrepareViewStyleInfo
...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(GroupingPanel))
            ...
            'ImageList1
            '
            'i1 As Image = Image.FromFile(Syncfusion.Windows.Forms.WinFormsUtils.FindFile("res", "flag_clear.png"))

            Dim o1 As Image = Image.FromFile(Syncfusion.Windows.Forms.WinFormsUtils.FindFile("res", "orange_square.png"))
            Dim g1 As Image = Image.FromFile(Syncfusion.Windows.Forms.WinFormsUtils.FindFile("res", "green_square.png"))
            Dim b1 As Image = Image.FromFile(Syncfusion.Windows.Forms.WinFormsUtils.FindFile("res", "blue_square.png"))
            Dim r1 As Image = Image.FromFile(Syncfusion.Windows.Forms.WinFormsUtils.FindFile("res", "red_square.png"))
            Dim v1 As Image = Image.FromFile(Syncfusion.Windows.Forms.WinFormsUtils.FindFile("res", "violet_square.png"))
            Dim y1 As Image = Image.FromFile(Syncfusion.Windows.Forms.WinFormsUtils.FindFile("res", "yellow_square.png"))
            Dim s1 As Image = Image.FromFile(Syncfusion.Windows.Forms.WinFormsUtils.FindFile("res", "square.png"))

            'Me.ImageList1.ImageStream = CType(resources.GetObject("ImageList1.ImageStream"), System.Windows.Forms.ImageListStreamer)
            Me.ImageList1.Images.AddRange(New Image() {o1, g1, b1, r1, v1, y1, s1})
            Me.ImageList1.TransparentColor = System.Drawing.Color.Transparent
            Me.ImageList1.Images.SetKeyName(0, "orange_square.png")
            Me.ImageList1.Images.SetKeyName(1, "green_square.png")
            Me.ImageList1.Images.SetKeyName(2, "blue_square.png")
            Me.ImageList1.Images.SetKeyName(3, "red_square.png")
            Me.ImageList1.Images.SetKeyName(4, "violet_square.png")
            Me.ImageList1.Images.SetKeyName(5, "yellow_square.png")
            Me.ImageList1.Images.SetKeyName(6, "square.png")
            '
            'normalViewPopUpMenu
            '
            ...
            'headerParentBarItem
            '
            Me.headerParentBarItem.CustomTextFont = New System.Drawing.Font("Calibri", 9.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
...
#Region "Class helper functions"
        ...
        Private Sub CreateFirstColumnSet(ByVal name As String, ByVal rows As Integer)
            ...
            Dim csd1 As GridColumnSetDescriptor = New GridColumnSetDescriptor(name) ' Mails Icon column
        ...
        Private Sub CreateSecondColumnSet(ByVal name As String, ByVal rows As Integer)
            Dim csd2 As GridColumnSetDescriptor = New GridColumnSetDescriptor(name)
...
Continue1:
        ...
        Private Sub CreateThirdColumnSet(ByVal name As String, ByVal rows As Integer)
            Dim csd3 As GridColumnSetDescriptor = New GridColumnSetDescriptor(name)
        ...
        Private Sub CreateFourthColumnSet(ByVal name As String, ByVal rows As Integer)
            ...
            Dim csd4 As GridColumnSetDescriptor = New GridColumnSetDescriptor(name)
        ...
        Private Sub RollBackSizeChanges()
            ...
            For Each keys As String In Ht_ColWidth.Keys
                Me.gridGroupingControl1.TableDescriptor.Columns(keys).Width = CInt(Ht_ColWidth(keys))
            Next keys
        End Sub
        ''' <summary>
        ...
        Private Function ComputePeriodReceived(ByVal dateReceivedInTotalDays As Integer) As Integer
            ...
            Dim nDay As Integer = CInt(TodaysDate.DayOfWeek)
        ...
        Public Sub ExpandthisGroup()
            ...
            If row >= 0 AndAlso Me.gridGroupingControl1.Table.NestedDisplayElements(row).IsCaption() Then
                If TypeOf el Is GridCaptionRow Then
                    Dim crow As GridCaptionRow = CType(el, GridCaptionRow)
                    Dim gp As Group = crow.ParentGroup
                    gp.IsExpanded = True
                ElseIf TypeOf el Is GridCaptionSection Then
                    Dim crow As GridCaptionSection = CType(el, GridCaptionSection)
                    Dim gp As Group = crow.ParentGroup
                    gp.IsExpanded = True
                End If
            End If
        ...
        Private Sub ApplythisGroupwithFlag(ByVal thisFlag As Integer)
            ...
            'ORIGINAL LINE: for (; rows < Me.gridGroupingControl1.Table.NestedDisplayElements.Count; rows += 1)
            'INSTANT VB NOTE: This 'for' loop was translated to a VB 'Do While' loop:
...
#Region "GridGroupingControl event handlers"
        ...
        Private Sub TableModel_QueryColWidth(ByVal sender As Object, ByVal e As GridRowColSizeEventArgs)
            Dim gridModel As GridTableModel = CType(IIf(TypeOf sender Is GridTableModel, sender, Nothing), GridTableModel)
            If NormalView Then
                ' proportional sizing of the normal view
                Dim factor As Single = 0.0F
        ...
        Private Sub gridGroupingControl1_QueryCellStyleInfo(ByVal sender As Object, ByVal e As GridTableCellStyleInfoEventArgs)
            If Me.gridGroupingControl1.TableOptions.ShowRecordPreviewRow Then
                If e.TableCellIdentity.TableCellType = GridTableCellType.RecordPreviewCell Then
                    Dim record As GridRecord = CType(IIf(TypeOf e.TableCellIdentity.DisplayElement.ParentRecord Is GridRecord, e.TableCellIdentity.DisplayElement.ParentRecord, Nothing), GridRecord)
                ...
                End If
            End If
            If e.Style.CellType = "ColumnHeaderCell" Then
            ...
            End If
            If Not e.Style Is Nothing AndAlso Not e.TableCellIdentity.Column Is Nothing Then
                e.Style.Font.Facename = "Calibri"
                e.Style.Font.Size = 10.0F
                e.Style.Trimming = StringTrimming.EllipsisCharacter
                ...
                If e.TableCellIdentity.Column.Name = "flag" Then
                    If e.Style.CellType <> "ColumnHeaderCell" Then
                        ...
                        '						Rectangle rect = this.gridGroupingControl1.TableControl.RangeInfoToRectangle(GridRangeInfo.Cell(e.TableCellIdentity.RowIndex, e.TableCellIdentity.ColIndex));
                ...
                If e.TableCellIdentity.Column.Name = "mails" Then
                    If e.Style.CellType <> "ColumnHeaderCell" Then
                        ...
                        e.Style.ImageIndex = CInt(e.Style.CellValue)
                    End If
                    If e.Style.CellType = "ColumnHeaderCell" Then
                        e.Style.CellType = "Static"
                ...
                If TypeOf e.TableCellIdentity.DisplayElement Is GridRecordRow Then
                    If Me.NormalView Then
                        Dim dr As DataRowView = CType(IIf(TypeOf e.TableCellIdentity.DisplayElement.ParentRecord.GetData() Is DataRowView, e.TableCellIdentity.DisplayElement.ParentRecord.GetData(), Nothing), DataRowView)
                        If Not dr Is Nothing AndAlso Convert.ToInt32(dr("ReadState")) = 1 Then
                            e.Style.Font.Bold = False
                            If e.TableCellIdentity.Column.Name = "mails" AndAlso e.Style.CellType <> "ColumnHeaderCell" AndAlso CInt(e.Style.CellValue) = 0 Then
                                e.Style.ImageIndex = 1
                            End If
                        ElseIf Not dr Is Nothing AndAlso Convert.ToInt32(dr("ReadState")) = 0 Then
                            e.Style.Font.Bold = True
                            If e.TableCellIdentity.Column.Name = "mails" AndAlso e.Style.CellType <> "ColumnHeaderCell" AndAlso CInt(e.Style.CellValue) = 1 Then
                                e.Style.ImageIndex = 0
                            End If
                        End If
                    End If
            ...
            If e.TableCellIdentity.TableCellType = GridTableCellType.GroupCaptionCell Then
                ...
                e.Style.Borders.Top = New GridBorder(GridBorderStyle.None, Color.FromArgb(Form1.r, Form1.g, Form1.b), GridBorderWeight.ExtraThin)
                e.Style.Borders.Bottom = New GridBorder(GridBorderStyle.Solid, Color.FromArgb(Form1.r, Form1.g, Form1.b), GridBorderWeight.ExtraThin)
        ...
        Private Sub TableModel_QueryCoveredRange(ByVal sender As Object, ByVal e As GridQueryCoveredRangeEventArgs)
            If (Not normalView_Renamed) Then
                Dim tm As GridTableModel = CType(IIf(TypeOf sender Is GridTableModel, sender, Nothing), GridTableModel)
        ...
        Private Sub GroupedColumns_Changed(ByVal sender As Object, ByVal e As ListPropertyChangedEventArgs)
            Dim scd As Syncfusion.Grouping.SortColumnDescriptor = CType(IIf(TypeOf e.Item Is Syncfusion.Grouping.SortColumnDescriptor, e.Item, Nothing), Syncfusion.Grouping.SortColumnDescriptor)
                ...
                If e.Inner.KeyCode = Keys.Down Then
                    ...
                    Else
                        ...
                        If Me.gridGroupingControl1.Table.NestedDisplayElements(catchRecord + 2).IsRecord() Then
                            ...
                            Me.gridGroupingControl1.TableControl.Selections.Add(GridRangeInfo.Rows(catchRecord = catchRecord + 2, catchPreview = catchPreview + 2))
                        ...
                        ElseIf Me.gridGroupingControl1.Table.NestedDisplayElements(catchRecord + 1).IsCaption() Then
                            ...
                            Me.gridGroupingControl1.TableControl.Selections.Add(GridRangeInfo.Rows(catchRecord = catchRecord + 1, catchPreview = catchPreview + 1))
                        ElseIf Me.gridGroupingControl1.Table.NestedDisplayElements(catchRecord + 2).IsCaption() Then
                            ...
                            Me.gridGroupingControl1.TableControl.Selections.Add(GridRangeInfo.Rows(catchRecord = catchRecord + 2, catchPreview = catchPreview + 1))
                        End If
                    End If
                ...
                If e.Inner.KeyCode = Keys.Up Then
                    ...
                    Else
                        ...
                        ElseIf Me.gridGroupingControl1.Table.NestedDisplayElements(catchRecord - 1).IsCaption() Then
                            ...
                            Me.gridGroupingControl1.TableControl.Selections.Add(GridRangeInfo.Rows(catchRecord = catchRecord - 1, catchPreview = catchPreview - 2))
                        End If
                    End If
                    ' Move the scroll bar together.. 
        ...
        Private Function LocateSelectionToKey(ByVal key As Keys) As Integer
            ...
            If CInt(key) > CInt(Keys.Z) OrElse CInt(key) < CInt(Keys.A) Then
                Return -1
            End If
            ...
            Do While notfound
                ...
                'ORIGINAL LINE: for (int row = 2; row < Me.gridGroupingControl1.Table.DisplayElements.Count; row += 1)
                'INSTANT VB NOTE: This 'for' loop was translated to a VB 'Do While' loop:
                Do While row < Me.gridGroupingControl1.Table.DisplayElements.Count
                ...
                If Me.gridGroupingControl1.TableControl.Selections.GetSelectedRows(True, False).AnyRangeContains(GridRangeInfo.Row(e.RowIndex)) Then
                    ...
                    If e.ColIndex = Me.gridGroupingControl1.TableDescriptor.Columns.IndexOf("flag") + 2 Then
                        Try
                            ...
                            ' If Mouse Hovers..
                            Dim mousePosition As Point = Windows.Forms.Cursor.Position
        ...
        Private Sub Model_SelectionChanging(ByVal sender As Object, ByVal e As GridSelectionChangingEventArgs)
            ...
            If Not Me.gridGroupingControl1.Table.NestedDisplayElements(row) Is Nothing AndAlso Me.gridGroupingControl1.Table.NestedDisplayElements(row).IsRecord() Then
        ...
        Private Sub gridGroupingControl1_TableControlCellDrawn(ByVal sender As Object, ByVal e As GridTableControlDrawCellEventArgs)
            If e.Inner.RowIndex = 1 Then
                ...
                If colName = "Subject" OrElse colName = "Received" OrElse colName = "From" OrElse colName = "Size" Then
                    Dim style As GridTableCellStyleInfo = e.TableControl.GetTableViewStyleInfo(e.Inner.RowIndex, e.Inner.ColIndex)
                    If Not style.Tag Is Nothing Then
                        ...
                        If style.Tag.ToString() = "Ascending" Then
                            Dim p1 As Point = New Point(rect.X - 4, rect.Y + 6)
                            Dim p2 As Point = New Point(rect.X, rect.Y + 2)
                            Dim p3 As Point = New Point(rect.X + 4, rect.Y + 6)
                            ...
                            e.Inner.Graphics.FillPolygon(New SolidBrush(Color.FromArgb(154, 198, 255)), New Point() {p1, p2, p3})
                        Else
                            Dim p1 As Point = New Point(rect.X - 4, rect.Y + 2)
                            Dim p2 As Point = New Point(rect.X, rect.Y + 6)
                            Dim p3 As Point = New Point(rect.X + 4, rect.Y + 2)
...
#Region "Normal view Popup menu handlers"
        ...
        Private Sub barItem_FieldChooser_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles barItem_FieldChooser.Click
            Dim hiddenCols As String() = New String(Me.gridGroupingControl1.TableDescriptor.Columns.Count - 1) {}
            Dim flag As Boolean = False
            Dim hiddenIndex As Integer = 0
            Dim temp As String
            Dim i As Integer = 0
            'ORIGINAL LINE: for (int i = 0; i < hiddenCols.Length; i += 1)
            'INSTANT VB NOTE: This 'for' loop was translated to a VB 'Do While' loop:
            Do While i < hiddenCols.Length
                temp = Me.gridGroupingControl1.TableDescriptor.Columns(i).Name
                Dim j As Integer = 0
                'ORIGINAL LINE: for (int j = 0; j < visibleCols.Length; j += 1)
                'INSTANT VB NOTE: This 'for' loop was translated to a VB 'Do While' loop:
                Do While j < visibleCols.Length
                ...
                i += 1
            Loop
            Dim dlg As FieldChooserDialog = New FieldChooserDialog(hiddenCols, visibleCols)
...
#Region "Flag Menu context menu handlers"
        ...
        Private Sub redAsDefaultBarItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles redAsDefaultBarItem.Click, RedAsDefaultfromRecordBarItem.Click
            Dim barItem As BarItem = CType(IIf(TypeOf sender Is BarItem, sender, Nothing), BarItem)
            ...
            'TODO: INSTANT VB TODO TASK: Assignments within expressions are not supported in VB.NET
            'ORIGINAL LINE: Me.redAsDefaultBarItem.Checked = Me.todayCaptionBarItem.Checked = Me.RedAsDefaultfromRecordBarItem.Checked = True;
            Me.redAsDefaultBarItem.Checked = Me.todayCaptionBarItem.Checked = Me.RedAsDefaultfromRecordBarItem.Checked = True
        End Sub
        ...
        Private Sub blueAsDefaultBarItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles blueAsDefaultBarItem.Click, BlueasDefaultfromRecordBarItem.Click
            ...
            ClearChecks(RecordFollowUpParentBarItem)
            'TODO: INSTANT VB TODO TASK: Assignments within expressions are not supported in VB.NET
            'ORIGINAL LINE: Me.blueAsDefaultBarItem.Checked = Me.tomoCaptionBarItem.Checked = Me.BlueasDefaultfromRecordBarItem.Checked = True;
            Me.blueAsDefaultBarItem.Checked = Me.tomoCaptionBarItem.Checked = Me.BlueasDefaultfromRecordBarItem.Checked = True
        End Sub
        ...
        Private Sub yellowAsDefaultBarItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles yellowAsDefaultBarItem.Click, YellowasDefaultfromRecordBarItem.Click
            ...
            ClearChecks(RecordFollowUpParentBarItem)
            'TODO: INSTANT VB TODO TASK: Assignments within expressions are not supported in VB.NET
            'ORIGINAL LINE: Me.yellowAsDefaultBarItem.Checked = Me.thisweekfromCaptionBarItem.Checked = Me.YellowasDefaultfromRecordBarItem.Checked = True;
            Me.yellowAsDefaultBarItem.Checked = Me.thisweekfromCaptionBarItem.Checked = Me.YellowasDefaultfromRecordBarItem.Checked = True
        End Sub
        ...
        Private Sub greenAsDefaultBarItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles greenAsDefaultBarItem.Click, GreenasDefaultfromRecordBarItem.Click
            ...
            ClearChecks(RecordFollowUpParentBarItem)
            'TODO: INSTANT VB TODO TASK: Assignments within expressions are not supported in VB.NET
            'ORIGINAL LINE: Me.greenAsDefaultBarItem.Checked = Me.nextweekCaptionBarItem.Checked = Me.GreenasDefaultfromRecordBarItem.Checked = True;
            Me.greenAsDefaultBarItem.Checked = Me.nextweekCaptionBarItem.Checked = Me.GreenasDefaultfromRecordBarItem.Checked = True
        End Sub
        ...
        Private Sub orangeAsDefaultBarItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles orangeAsDefaultBarItem.Click, OrangeasDefaultfromRecordBarItem.Click
            ...
            ClearChecks(RecordFollowUpParentBarItem)
            'TODO: INSTANT VB TODO TASK: Assignments within expressions are not supported in VB.NET
            'ORIGINAL LINE: Me.orangeAsDefaultBarItem.Checked = Me.markcompletefromCaptionBarItem.Checked = Me.OrangeasDefaultfromRecordBarItem.Checked = True;
            Me.orangeAsDefaultBarItem.Checked = Me.markcompletefromCaptionBarItem.Checked = Me.OrangeasDefaultfromRecordBarItem.Checked = True
        End Sub
        ...
        Private Sub purpleAsDefaultBarItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles purpleAsDefaultBarItem.Click, PurpleasDefaultfromRecordBarItem.Click
            ...
            ClearChecks(RecordFollowUpParentBarItem)
            'TODO: INSTANT VB TODO TASK: Assignments within expressions are not supported in VB.NET
            'ORIGINAL LINE: Me.purpleAsDefaultBarItem.Checked = Me.PurpleasDefaultfromRecordBarItem.Checked = Me.clearflagCaptionBarItem.Checked = True;
            Me.purpleAsDefaultBarItem.Checked = Me.PurpleasDefaultfromRecordBarItem.Checked = Me.clearflagCaptionBarItem.Checked = True
        End Sub
#End Region
...
#Region "Record fields context menu handlers"
        ...
        Private Sub DeletefromRecordBarItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles DeletefromRecordBarItem.Click
            ...
            Dim dr As DataRow = CType(IIf(TypeOf Me.gridGroupingControl1.Table.NestedDisplayElements(rowas).GetRecord().GetData() Is DataRow, Me.gridGroupingControl1.Table.NestedDisplayElements(rowas).GetRecord().GetData(), Nothing), DataRow)
...
#Region "Caption PopUp Menu Handlers"
        ...
        Private Sub ExpandAllGroupsBarItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ExpandAllGroupsBarItem.Click
            ...
            Do
                Dim elt As Element = Me.gridGroupingControl1.Table.NestedDisplayElements(i = i + 1)
                If elt.Kind = DisplayElementKind.Caption Then
                    count += 1
                End If
