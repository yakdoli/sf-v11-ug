...
namespace OutlookDemo
{
    ...
    public class GroupingPanel : System.Windows.Forms.Panel
    {
        ...
        private DataTable GetTable()
        {
            ...
            dt.Rows.Add(new object[] { string.Empty, "Cindy", "Eval version Key", DateTime.Now, 0, 0, "Jake", "Please provide me the key to the new version", 5010, string.Empty, "Red Category", (int)flags.Red });
            ...
            dt.Rows.Add(new object[] { string.Empty, "Ted", "User Account", DateTime.Now.AddHours(-3), 0, 0, "Jake", "User accounts have been created", 55000, 1, null, (int)flags.Clear });
            ...
            dt.Rows.Add(new object[] { string.Empty, "George", "Installation Procedure", DateTime.Now.AddDays(-42), 2, 1, "Jake", "It is uploaded in server. Please go through this", 20400, string.Empty, null, (int)flags.Clear });
        ...
        private void InitializeComponent()
        {
            ...
            this.imageList1.Images.SetKeyName(1, "blue_square.png");
            this.imageList1.Images.SetKeyName(2, "green_square.png");
            this.imageList1.Images.SetKeyName(3, "orange_square.png");
            this.imageList1.Images.SetKeyName(4, "violet_square.png");
            this.imageList1.Images.SetKeyName(5, "yellow_square.png");
            this.imageList1.Images.SetKeyName(6, "square.png");
            // 
        ...
        {
            // from the row of the nested display elemnt 
            ...
            if (row >= 0 && this.gridGroupingControl1.Table.NestedDisplayElements[row].IsCaption())
            {
                ...
                else if (el is GridCaptionSection)
                {
                    GridCaptionSection crow = (GridCaptionSection)el;
                    Group gp = crow.ParentGroup;
                    gp.IsExpanded = true;
                }
            }
