...
namespace OutlookDemo
{
	...
	public class CalendarForm : System.Windows.Forms.UserControl
    {
        ...
        public CalendarForm()
		{
			...
			//this.scheduleControl1.Appearance.AllDayBackColor = Color.FromArgb( 165, 191, 225 );
			////this.scheduleControl1.Appearance.MarkColumnColor = Color.FromArgb( 227, 239, 255 );
			//this.scheduleControl1.Appearance.MonthWeekHeaderBackColor = Color.FromArgb( 194,212,235 );
			//this.scheduleControl1.Appearance.MonthWeekHeaderForeColor = Color.FromArgb( 228, 236, 246 );
			//this.scheduleControl1.Appearance.NavigationCalendarArrowColor = Color.FromArgb( 111, 157, 217 );
			//this.scheduleControl1.Appearance.NavigationCalendarBackColor = Color.White;
			//this.scheduleControl1.Appearance.NavigationCalendarHeaderColor = Color.FromArgb( 191, 219, 255 );
			//this.scheduleControl1.Appearance.NavigationCalendarTodayColor = Color.FromArgb( 187, 85, 3 );
			//this.scheduleControl1.Appearance.NavigationCalendarSelectionColor = Color.FromArgb(251, 200, 79);
			//this.scheduleControl1.Appearance.NonPrimeTimeCellColor = Color.FromArgb(230, 237, 247);
			//this.scheduleControl1.Appearance.PrimeTimeCellColor = Color.White;
			//this.scheduleControl1.Appearance.SolidBorderColor = Color.FromArgb(165, 191, 225);
			//this.scheduleControl1.Appearance.SplitterBackColor = Color.FromArgb(227, 239, 255);
			//this.scheduleControl1.Appearance.TimeBackColor = Color.FromArgb(227, 239, 255);
			//this.scheduleControl1.Appearance.TimeTextColor = Color.FromArgb(101, 147, 207);
			//this.scheduleControl1.Appearance.CaptionBackColor = Color.FromArgb(227, 239, 255);
			//this.scheduleControl1.Appearance.DragColor = Color.FromArgb(165, 191, 225);
			//this.scheduleControl1.BackColor = Color.FromArgb(227, 239, 255);
            this.scheduleControl1.EnableAlerts = true;
			//this.scheduleControl1.Appearance.WorkWeekHeaderBackColor = Color.FromArgb(194, 212, 235);
			//this.scheduleControl1.Appearance.WorkWeekHeaderForeColor = Color.FromArgb(228, 236, 246);
