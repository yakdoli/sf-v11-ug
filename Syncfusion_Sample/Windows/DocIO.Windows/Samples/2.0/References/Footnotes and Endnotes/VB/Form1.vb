...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Me.button1.Location = New System.Drawing.Point(284, 210)
        ...
        "ote that MS Word Viewer or MS Word is required to view the resultant document."
            ...
            Me.Text = "Footnotes and Endnotes"
...
#Region "CreateFootNote"
        Private Sub CreateFootNote(ByVal document As WordDocument)
            ...
            Dim textRange As IWTextRange = paragraph.AppendText(Constants.vbTab + Constants.vbTab + Constants.vbTab + Constants.vbTab + Constants.vbTab & "Demo for Footnote")
            ...
            paragraph.AppendPicture(Image.FromFile("..\..\..\..\..\..\..\..\..\Common\images\DocIO\DocIO.gif"))
            ...
            'Insert Text into the paragraph
            paragraph.AppendText("Essential PDF").CharacterFormat.Bold = True
            paragraph = section.AddParagraph()
            paragraph.ParagraphFormat.HorizontalAlignment = Syncfusion.DocIO.DLS.HorizontalAlignment.Center
            paragraph.AppendPicture(Image.FromFile("..\..\..\..\..\..\..\..\..\Common\images\DocIO\\pdf.gif"))

            paragraph = footnote.TextBody.AddParagraph()
            paragraph.AppendText(" Essential PDF is a Non UI component that can be used to create PDF documents in both ASP.NET and windows forms applications.  ")
            ...
            'Insert Text into the paragraph
            paragraph.AppendText("Essential XlsIO").CharacterFormat.Bold = True
            paragraph = section.AddParagraph()
            paragraph.ParagraphFormat.HorizontalAlignment = Syncfusion.DocIO.DLS.HorizontalAlignment.Center
            paragraph.AppendPicture(Image.FromFile("..\..\..\..\..\..\..\..\..\Common\images\DocIO\XlsIO.gif"))
            paragraph = footnote.TextBody.AddParagraph()
            paragraph.AppendText(" Essential XlsIO is a Non UI component that can be used to create Excel documents in both ASP.NET and windows forms applications.  ")
...
#Region "CreateEndNote"
        Private Sub CreateEndNote(ByVal document As WordDocument)
            'Add a new section to the document.
            Dim section As IWSection = document.AddSection()
            ...
            Dim textRange As IWTextRange = paragraph.AppendText(Constants.vbTab + Constants.vbTab + Constants.vbTab + Constants.vbTab + Constants.vbTab & "Demo for Endnote")
            textRange.CharacterFormat.TextColor = Color.Black
            textRange.CharacterFormat.Bold = True
            textRange.CharacterFormat.FontSize = 20
