...
namespace EssentialDocIOSamples
{
    ...
    "ote that MS Word Viewer or MS Word is required to view the resultant document.";
        ...
        private void button1_Click(object sender, System.EventArgs e)
        {
            ...
            WPicture picture = paragraph.AppendPicture(Image.FromFile(dataPath + "MetroStudio1.png")) as WPicture;
            ...
            paragraph.ParagraphFormat.LineSpacing = 12f;            
            //Appends picture to the paragraph.
            picture = paragraph.AppendPicture(Image.FromFile(dataPath + "MetroStudio2.png")) as WPicture;
            picture.TextWrappingStyle = TextWrappingStyle.TopAndBottom;
            picture.VerticalOrigin = VerticalOrigin.Paragraph;
            ...
            paragraph.ApplyStyle("Heading 1");
            paragraph.ParagraphFormat.LineSpacing = 12f;
            picture = paragraph.AppendPicture(Image.FromFile(dataPath + "MetroStudio3.png")) as WPicture;
            picture.TextWrappingStyle = TextWrappingStyle.TopAndBottom;
            picture.VerticalOrigin = VerticalOrigin.Paragraph;
            picture.VerticalPosition = 0;
            picture.HorizontalOrigin = HorizontalOrigin.Column;
