...
namespace EssentialDocIOSamples
{
    ...
    "ote that MS Word Viewer or MS Word is required to view the resultant document.";
            ...
            this.templateBtn.Location = new System.Drawing.Point(266, 182);
        ...
        private void GetDataTable()
        {
            ...
            string[] products = { "Studio", "Chart", "Edit", "Grid", "Tools", "Diagram", "XlsIO", "Grouping", "Calculate", "HTMLUI", "PDF", "DocIO" };
            ...
            foreach (string product in products)
            {
                ...
                {
                    case "Studio":
                        row["Binary"] = "$1,295.00"; break;
                    case "Grid":
                        row["Binary"] = "$595.00"; break;
                    default:
                        row["Binary"] = "$495.00"; break;
                }

                switch (product)
                {
                    case "Studio":
                        row["Source"] = "$1,995.00"; break;
                    case "Grid":
                        row["Source"] = "$995.00"; break;
                    default:
                        row["Source"] = "$895.00"; break;
                }
