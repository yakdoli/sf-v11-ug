...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Me.label2.Size = New System.Drawing.Size(369, 47)
        ...
        "ote that MS Word Viewer or MS Word is required to view the resultant document."
            ...
            Me.word2003RadioBtn.TabStop = True
...
#Region "Button Click"
        ...
        Private Sub button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles button1.Click
            ...
            Dim s As StreamReader = New StreamReader("..\..\..\..\..\..\..\..\..\Common\Data\DocIO\Arabic.txt", System.Text.Encoding.ASCII)
            Dim text As String = s.ReadToEnd()

            ' Appending Arabic text to the document.
            document.LastParagraph.ParagraphFormat.Bidi = True
            Dim txtRange As IWTextRange = document.LastParagraph.AppendText(text)
