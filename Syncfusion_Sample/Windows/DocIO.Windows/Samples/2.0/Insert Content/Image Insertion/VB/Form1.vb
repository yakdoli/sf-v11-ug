...
#Region "Button Click"
        ...
        Private Sub button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles button1.Click
            ...
            paragraph.AppendText("Essential XlsIO [.gif Image]")
            paragraph = section.AddParagraph()
            ...
            paragraph = section.AddParagraph()
            paragraph.AppendText("Essential Grid [.bmp Image]")
            paragraph = section.AddParagraph()
            paragraph.ParagraphFormat.HorizontalAlignment = Syncfusion.DocIO.DLS.HorizontalAlignment.Center
            'Inserting .bmp
            paragraph.AppendPicture(Image.FromFile(dataPath & "Ess Grid.bmp"))

            paragraph = section.AddParagraph()
            paragraph.AppendText("Essential Tools [.png Image]")
            paragraph = section.AddParagraph()
            paragraph.ParagraphFormat.HorizontalAlignment = Syncfusion.DocIO.DLS.HorizontalAlignment.Center
            'Inserting .png 
            paragraph.AppendPicture(Image.FromFile(dataPath & "Ess Tools.PNG"))

            paragraph = section.AddParagraph()
            paragraph.AppendText("Essential PDF [.tif Image]")
            paragraph = section.AddParagraph()
            paragraph.ParagraphFormat.HorizontalAlignment = Syncfusion.DocIO.DLS.HorizontalAlignment.Center
            'Inserting .tif 
            paragraph.AppendPicture(Image.FromFile(dataPath & "Ess PDF.tif"))
            ...
            Dim mImage As WPicture = CType(paragraph.AppendPicture(Image.FromFile(dataPath & "Ess chart.emf")), WPicture)
            'Scaling Image
