...
#### []{#p136}[]{#_AllowEdit}AllowEdit

 

AllowEdit property is used to specify whether the value in the control can be edited or not. The following code snippet illustrates this.
...
|                                                                                                                 |
| [numericUpDown.AllowEdit = [true]{style="COLOR: blue"};]{style="FONT-FAMILY: 'Courier New'"}                    |
+-----------------------------------------------------------------------------------------------------------------+
