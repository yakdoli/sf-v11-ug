...
##### []{#p142}NegativeForeground

 

The NegativeForeground property specifies the foreground color for the input value when the input value is less than zero. The following code snippets illustrates this.
...
![](../ImagesExt/image261_257.jpg){border="0"}

 

Figure 327: NegativeForeground = \"Green\"
